...
public class BlockGlisteringSandstoneSmoothSlab extends ElementsWastelandsofBaedoor.ModElement {
	@GameRegistry.ObjectHolder("wobr:glistering_sandstone_smooth_slab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("glistering_sandstone_smooth_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("glistering_sandstone_smooth_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("wobr:glistering_sandstone_smooth_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("glistering_sandstone_smooth_slab");
