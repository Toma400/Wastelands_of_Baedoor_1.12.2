...
public class BlockSmooth_Vulcanic_Sand_Slab extends ElementsWastelandsofBaedoor.ModElement {
	@GameRegistry.ObjectHolder("wobr:smooth_vulcanic_sand_slab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("smooth_vulcanic_sand_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("smooth_vulcanic_sand_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("wobr:smooth_vulcanic_sand_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("smooth_vulcanic_sand_slab");
