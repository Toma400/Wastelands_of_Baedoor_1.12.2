...
public class BlockPolished_Vulcanic_Sand_Slab extends ElementsWastelandsofBaedoor.ModElement {
	@GameRegistry.ObjectHolder("wobr:polished_vulcanic_sand_slab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("polished_vulcanic_sand_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("polished_vulcanic_sand_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("wobr:polished_vulcanic_sand_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("polished_vulcanic_sand_slab");
