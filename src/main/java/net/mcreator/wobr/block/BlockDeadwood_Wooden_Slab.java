...
public class BlockDeadwood_Wooden_Slab extends ElementsWastelandsofBaedoor.ModElement {
	@GameRegistry.ObjectHolder("wobr:deadwood_wooden_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("wobr:deadwood_wooden_slab_double")
	public static final Block block_slab_double = null;
	public BlockDeadwood_Wooden_Slab(ElementsWastelandsofBaedoor instance) {
		super(instance, 84);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("deadwood_wooden_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("deadwood_wooden_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("wobr:deadwood_wooden_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("deadwood_wooden_slab");
