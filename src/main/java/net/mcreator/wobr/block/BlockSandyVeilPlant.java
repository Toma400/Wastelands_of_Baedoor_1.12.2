...
import net.mcreator.wobr.procedure.ProcedureSandyVeilGrowth;
...
public class BlockSandyVeilPlant extends ElementsWastelandsofBaedoor.ModElement {
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemSandDust.block, (int) (1)));
		}

		@Override
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(ItemSandDust.block, (int) (1));
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureSandyVeilGrowth.executeProcedure($_dependencies);
			}
		}
	}
}
