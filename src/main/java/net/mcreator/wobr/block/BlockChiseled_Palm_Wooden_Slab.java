...
public class BlockChiseled_Palm_Wooden_Slab extends ElementsWastelandsofBaedoor.ModElement {
	@GameRegistry.ObjectHolder("wobr:chiseled_palm_wooden_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("wobr:chiseled_palm_wooden_slab_double")
	public static final Block block_slab_double = null;
	public BlockChiseled_Palm_Wooden_Slab(ElementsWastelandsofBaedoor instance) {
		super(instance, 89);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("chiseled_palm_wooden_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("chiseled_palm_wooden_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("wobr:chiseled_palm_wooden_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("chiseled_palm_wooden_slab");
