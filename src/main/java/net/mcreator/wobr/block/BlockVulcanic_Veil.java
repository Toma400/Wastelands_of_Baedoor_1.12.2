...
public class BlockVulcanic_Veil extends ElementsWastelandsofBaedoor.ModElement {
	@GameRegistry.ObjectHolder("wobr:vulcanic_veil")
	public static final Block block = null;
	public BlockVulcanic_Veil(ElementsWastelandsofBaedoor instance) {
		super(instance, 71);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("wobr:vulcanic_veil", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("vulcanic_veil");
			setRegistryName("vulcanic_veil");
		}
