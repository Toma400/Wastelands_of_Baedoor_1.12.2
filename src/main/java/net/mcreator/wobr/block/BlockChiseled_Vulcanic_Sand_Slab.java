...
public class BlockChiseled_Vulcanic_Sand_Slab extends ElementsWastelandsofBaedoor.ModElement {
	@GameRegistry.ObjectHolder("wobr:chiseled_vulcanic_sand_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("wobr:chiseled_vulcanic_sand_slab_double")
	public static final Block block_slab_double = null;
	public BlockChiseled_Vulcanic_Sand_Slab(ElementsWastelandsofBaedoor instance) {
		super(instance, 340);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("chiseled_vulcanic_sand_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("chiseled_vulcanic_sand_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("wobr:chiseled_vulcanic_sand_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("chiseled_vulcanic_sand_slab");
