...
public class BlockDark_Oak_Wooden_Slab extends ElementsWastelandsofBaedoor.ModElement {
	@GameRegistry.ObjectHolder("wobr:dark_oak_wooden_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("wobr:dark_oak_wooden_slab_double")
	public static final Block block_slab_double = null;
	public BlockDark_Oak_Wooden_Slab(ElementsWastelandsofBaedoor instance) {
		super(instance, 51);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dark_oak_wooden_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("dark_oak_wooden_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("wobr:dark_oak_wooden_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("dark_oak_wooden_slab");
