...
public class BlockGlisteringSandstoneSlab extends ElementsWastelandsofBaedoor.ModElement {
	@GameRegistry.ObjectHolder("wobr:glistering_sandstone_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("wobr:glistering_sandstone_slab_double")
	public static final Block block_slab_double = null;
	public BlockGlisteringSandstoneSlab(ElementsWastelandsofBaedoor instance) {
		super(instance, 302);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("glistering_sandstone_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("glistering_sandstone_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("wobr:glistering_sandstone_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("glistering_sandstone_slab");
