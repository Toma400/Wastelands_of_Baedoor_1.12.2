...
import net.mcreator.wobr.procedure.ProcedureComReaperingSwitch;
...
public class CommandReaperingSwitcher extends ElementsWastelandsofBaedoor.ModElement {
	...
	public static class CommandHandler implements ICommand {
		...
		public String getName() {
			return "wobrRule_Avoider";
		}

		@Override
		public String getUsage(ICommandSender var1) {
			return "/wobrRule_Avoider [<arguments>]";
		}
		...
		public void execute(MinecraftServer server, ICommandSender sender, String[] cmd) {
			...
			if (entity != null) {
				...
				});
				{
					...
					ProcedureComReaperingSwitch.executeProcedure($_dependencies);
				}
			}
		}
	}
