...
import net.mcreator.wobr.procedure.ProcedureCom_Reapering_Check;
...
public class CommandReapering_Checker extends ElementsWastelandsofBaedoor.ModElement {
	...
	public static class CommandHandler implements ICommand {
		...
		public String getName() {
			return "wobrCheck_Avoider";
		}

		@Override
		public String getUsage(ICommandSender var1) {
			return "/wobrCheck_Avoider [<arguments>]";
		}
		...
		public void execute(MinecraftServer server, ICommandSender sender, String[] cmd) {
			...
			if (entity != null) {
				...
				});
				{
					...
					ProcedureCom_Reapering_Check.executeProcedure($_dependencies);
				}
			}
		}
	}
