...
import net.mcreator.wobr.procedure.ProcedureWanderingTrades;
...
public class GuiWanderingTraderGUI extends ElementsWastelandsofBaedoor.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiWanderingTraderGUI(ElementsWastelandsofBaedoor instance) {
		super(instance, 126);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 23, 32) {
				@Override
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 43, 32) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 117, 32) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("wobr:textures/wanderingtradergui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("wobr:textures/wandering_trader_gui_4.png"));
			this.drawTexturedModalRect(this.guiLeft + 13, this.guiTop + 7, 0, 0, 256, 256);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 139, this.guiTop + 30, 10, 20, "»"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureWanderingTrades.executeProcedure($_dependencies);
			}
		}
	}
