...
public class ItemGuideBook extends ElementsWastelandsofBaedoor.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("wobr:guide_book", "inventory"));
	}
