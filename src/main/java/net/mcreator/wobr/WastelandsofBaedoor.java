 ...
 *
 *    Keep the ElementsWastelandsofBaedoor object in this class and all calls to this object
...
public class WastelandsofBaedoor {
	...
	public static final String VERSION = "12v0.a6";
	...
	@Mod.Instance(MODID)
	public static WastelandsofBaedoor instance;
	public ElementsWastelandsofBaedoor elements = new ElementsWastelandsofBaedoor();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsWastelandsofBaedoor.GuiHandler());
